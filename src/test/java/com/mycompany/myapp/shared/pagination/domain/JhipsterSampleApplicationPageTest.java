...
class JhipsterSampleApplicationPageTest {
  ...
  void shouldBeLastPageWithoutContent() {
    JhipsterSampleApplicationPage<Object> page = JhipsterSampleApplicationPage.builder(List.of())
      .currentPage(0)
      .pageSize(1)
  ...
  void shouldGetPageFromElements() {
    JhipsterSampleApplicationPage<String> page = JhipsterSampleApplicationPage.of(
      List.of("hello", "java", "world"),
      new JhipsterSampleApplicationPageable(1, 1)
    );
  ...
  void shouldGetEmptyPageFromOutOfBoundElements() {
    JhipsterSampleApplicationPage<String> page = JhipsterSampleApplicationPage.of(
      List.of("hello", "java", "world"),
      new JhipsterSampleApplicationPageable(4, 1)
    );
  ...
  void shouldGetPageWithLessThanExpectedElements() {
    JhipsterSampleApplicationPage<String> page = JhipsterSampleApplicationPage.of(
      List.of("hello", "java", "world"),
      new JhipsterSampleApplicationPageable(0, 4)
    );
